...
@ConditionalOnProperty(name = "embedding.model", havingValue = "clip", matchIfMissing = true)
public class ClipFeatureExtractor implements FeatureExtractor {
    ...
    private float[][][][] preprocess(BufferedImage src) {
        ...
        BufferedImage resized = resize(rgb, newW, newH, java.awt.RenderingHints.VALUE_INTERPOLATION_BICUBIC);
    ...
    private static BufferedImage padToSize(BufferedImage resized, int targetW, int targetH) {
        ...
        java.util.Arrays.fill(blackPixels, 0xFF000000);
    ...
    private static BufferedImage resize(BufferedImage src, int w, int h, Object interpolation) {
        ...
        try {
            g.setRenderingHint(java.awt.RenderingHints.KEY_INTERPOLATION, interpolation);
